...
import (
	...
	_ "github.com/peiman/changie/.ckeletin/pkg/config/commands" // Import to trigger init() functions (framework)
	_ "github.com/peiman/changie/internal/config/commands"      // Import to trigger init() functions (project)
)
